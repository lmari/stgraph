...
/** Analysis DefiningNodes action: select the nodes defining the selected one. */
@SuppressWarnings("serial")
public class AnalysisDefiningNodes extends AbstractActionDefault {
	...
	public final void exec() {
		...
		graph.getConnectedNodes((STNode)graph.getSelectionCell(), STGraphImpl.EDGEMODE_IN, false, true);
	}
