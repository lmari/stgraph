...
public class EditRedo extends AbstractActionDefault {
	...
	public EditRedo(final String keyChar, final int modifiers) { super(keyChar, modifiers); }
	...
	public final void setEnabledOnState() {
		...
		setEnabled(stc.isCurrentDesktop() && graph.isEditable && STGraphC.getUndoManager().canRedo(graph.getGraphLayoutCache()));
	}
	...
	public final void exec() {
		...
		try { undoManager.redo(graph.getGraphLayoutCache()); }
		catch (Exception ex) { ; }
		finally {
