...
/** Insert Chart action. */
public class InsertChart extends AbstractActionDefault {
	...
	public InsertChart(final String keyChar, final int modifiers) { super(keyChar, modifiers); }


	/** Action method. */
	public final void exec() {
		STGraphC stc = STGraph.getSTC();
		ChartWidget widget = (ChartWidget)STFactory.widgetCreate(ChartWidget.ID);
