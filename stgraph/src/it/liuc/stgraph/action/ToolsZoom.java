...
public class ToolsZoom extends AbstractActionDefault {
	...
	public ToolsZoom(final String keyChar, final int modifiers) { super(keyChar, modifiers); }
	...
	public final void exec() {
		double n = 1 / STGraph.getSTC().getCurrentGraph().getScale();
		STGraph.getSTC().getCurrentGraph().setScale(1.0);
