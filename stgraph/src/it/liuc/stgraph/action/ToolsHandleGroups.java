...
/** Tools HandleGroups action. */
public class ToolsHandleGroups extends AbstractActionDefault {
	...
	public ToolsHandleGroups() { ; }


	/** Class constructor.
	 * @param modifiers the modifiers
	 * @param keyChar the key char */
	public ToolsHandleGroups(final String keyChar, final int modifiers) { super(keyChar, modifiers); }
	...
	/** Action method. */
	@Override
	public final void exec() { GroupListDialog.showDialog(); }
