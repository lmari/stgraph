...
/** Edit Copy Widget to Clipboard action. */
public class EditCopyWidget extends AbstractActionDefault {
	...
	public final void setEnabledOnState() {
		...
		setEnabled(stc.isCurrentDesktop() && graph.isEditable && graph.getSelectionCount() == 1 && STTools.isWidget(graph.getSelectionCell()));
	}


	/** Action method. */
	public final void exec() {
		STTools.copyImageToClipboard(((STWidget)STGraph.getSTC().getCurrentGraph().getSelectionCell()).panel);
	}
