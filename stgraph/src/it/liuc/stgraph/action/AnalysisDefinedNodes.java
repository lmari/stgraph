...
/** Analysis DefinedNodes action: select the nodes defined by the selected one. */
@SuppressWarnings("serial")
public class AnalysisDefinedNodes extends AbstractActionDefault {
	...
	public final void exec() {
		...
		graph.getConnectedNodes((STNode)graph.getSelectionCell(), STGraphImpl.EDGEMODE_OUT, false, true);
	}
