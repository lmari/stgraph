...
/** WebTuneModel action. */
public class WebTuneModel extends AbstractActionDefault {
	...
	public WebTuneModel(final String keyChar, final int modifiers) { super(keyChar, modifiers); }
	...
	/** Action method. */
	@Override
	public final void exec() { new STWebTuner(); }
