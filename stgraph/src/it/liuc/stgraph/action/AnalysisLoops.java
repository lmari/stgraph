...
/** Analysis Loop action: highlight the arrows, if any, costituting a loop that includes the selected node. */
@SuppressWarnings("serial")
public class AnalysisLoops extends AbstractActionDefault {
	...
	public final void exec() {
		...
		graph.getLoops((STNode)graph.getSelectionCell());
		if(graph.getLoopEdgeList().size() > 0) { graph.highlightLoops(); }
	}
