...
/** Tools HandleWidgets action. */
public class ToolsHandleWidgets extends AbstractActionDefault {
	...
	public ToolsHandleWidgets() { ; }


	/** Class constructor.
	 * @param keyChar the key char
	 * @param modifiers the modifiers */
	public ToolsHandleWidgets(final String keyChar, final int modifiers) { super(keyChar, modifiers); }
	...
	/** Action method. */
	@Override
	public final void exec() { WidgetListDialog.showDialog(); }
