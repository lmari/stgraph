...
/** Edit Copy Graph to Clipboard action. */
public class EditCopyGraph extends AbstractActionDefault {
	...
	public final void setEnabledOnState() {
		...
		setEnabled(stc.isCurrentDesktop() && graph.isEditable);
	}


	/** Action method. */
	public final void exec() {
		STTools.copyImageToClipboard((STGraph.getSTC().getCurrentGraph()));
	}
