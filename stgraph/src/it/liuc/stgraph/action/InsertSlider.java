...
import it.liuc.stgraph.widget.SliderWidget;


/** Insert Slider action. */
public class InsertSlider extends AbstractActionDefault {
	...
	public InsertSlider(final String keyChar, final int modifiers) { super(keyChar, modifiers); }


	/** Action method. */
	public final void exec() {
		STGraphC stc = STGraph.getSTC();
		SliderWidget widget = (SliderWidget)STFactory.widgetCreate(SliderWidget.ID);
