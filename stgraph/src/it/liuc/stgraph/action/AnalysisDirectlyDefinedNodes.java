...
/** Analysis DirectlyDefinedNodes action: select the nodes directly defined by the selected one. */
@SuppressWarnings("serial")
public class AnalysisDirectlyDefinedNodes extends AbstractActionDefault {
	...
	public AnalysisDirectlyDefinedNodes() { ; }
	...
	public final void exec() {
		...
		graph.getConnectedNodes((STNode)graph.getSelectionCell(), STGraphImpl.EDGEMODE_OUT, true, true);
	}
