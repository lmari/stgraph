...
/** Analysis CheckGraph action. */
@SuppressWarnings("serial")
public class AnalysisCheckGraph extends AbstractActionDefault {


	/** Default class constructor. */
	public AnalysisCheckGraph() { ; }
	...
	public final void exec() {
		STTools.infoTextDialog.showMe(STGraphC.getMessage("CHECK.TITLE"), STGraphChecker.check(STGraph.getSTC().getCurrentGraph()), true, InfoDialog.MODE_NODES); //$NON-NLS-1$
	}
