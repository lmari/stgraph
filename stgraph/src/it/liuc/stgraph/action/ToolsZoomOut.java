...
/** Tools ZoomOut action. */
@SuppressWarnings("serial")
public class ToolsZoomOut extends AbstractActionDefault {
	...
	public ToolsZoomOut(final String keyChar, final int modifiers) { super(keyChar, modifiers); }
