...
/** WebShowOverviewData action. */
public class WebShowOverviewData extends AbstractActionDefault {
	...
	public WebShowOverviewData() { ; }


	/** Class constructor.
	 * @param keyChar the key char
	 * @param modifiers the modifiers */
	public WebShowOverviewData(final String keyChar, final int modifiers) { super(keyChar, modifiers); }
	...
	public final void exec() {
		...
		for(String lang : graph.getModelLanguages()) {
			...
			id.showMe(STGraphC.getMessage("SYSTEM.DIALOG.FULLINFOTITLE"), graph.getWebOverview(lang), true); //$NON-NLS-1$
		}
	}
