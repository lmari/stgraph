...
/** Analysis OutgoingArrows action: select the arrow outgoing the selected one. */
@SuppressWarnings("serial")
public class AnalysisOutgoingArrows extends AbstractActionDefault {
	...
	public final void exec() {
		...
		STEdge[] list = graph.getNodeEdges((STNode)graph.getSelectionCell(), STGraphImpl.EDGEMODE_OUT);
