...
/** Define a custom text area. */
@SuppressWarnings("serial")
public class STTextArea extends JTextArea {

	/** Class constructor.
	 * @param dialog the dialog
	 * @param forNodes switch to define whether this is used in a dialog for node definition */
	public STTextArea(final JDialog dialog, final boolean forNodes) {
		super();
		setBackground(Color.WHITE);
		setBorder(BorderFactory.createLoweredBevelBorder());
		setLineWrap(true);
		setFont(new Font(STGraph.getMyFont(), Font.PLAIN, 11));
