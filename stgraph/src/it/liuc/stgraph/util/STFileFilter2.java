...
/**
 * Implement FileFilter by accepting the stg files and the subdirectories.
 */
public class STFileFilter2 implements FileFilter {
	...
	public final boolean accept(final File f) {
		...
		if(ext != null && ext.equals(STConfigurator.getProperty("FILEEXT.STANDARD"))) { return true; } //$NON-NLS-1$
		return false;
	}
