...
import it.liuc.stgraph.fun.utils.StudentTDistribution;
...
public class TDistribution extends STDistributionFun {
	 ...
	 * @return default data */
	@Override
	final double[] getDefaultParams() { return new double[] { 5.0 }; } // degrees of freedom
	 ...
	 * @return the object */
	@Override
	final Object exec(final double[] data) { return Tensor.newScalar(StudentTDistribution.nextDouble(data[0])); }
	 ...
	 * @return object */
	@Override
	final Object exec0(final double value, final double[] data) { return Tensor.newScalar(StudentTDistribution.pdf(data[0], value)); }
	 ...
	 * @return object */
	@Override
	final Object exec1(final double value, final double[] data) { return Tensor.newScalar(StudentTDistribution.cdf(data[0], value)); }
