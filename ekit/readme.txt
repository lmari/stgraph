Readme for the STGraph-modified version of EKit

	http://www.hexidec.com/ekit.php

Ekit is a free open source Java HTML editor applet and application.
The Ekit standalone also allows for HTML to be loaded and saved,
as well as serialized and saved as an RTF.
