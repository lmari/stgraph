...
public class VerticalConfigurationPanel extends JScrollablePanel {
	...
	public VerticalConfigurationPanel(final Locale locale) {
		this.locale = locale;
		initComponents();
	}

	public void setModel(AbstractSurfaceModel model) { modelSource1.setSurfaceModel(model); }

	private void initComponents() {
		ResourceBundle bundle = ResourceBundle.getBundle("net.ericaro.surfaceplotter.surface.VerticalConfigurationPanel", locale);
		label1 = new JLabel();
