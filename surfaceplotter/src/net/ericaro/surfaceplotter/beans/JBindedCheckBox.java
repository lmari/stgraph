...
public class JBindedCheckBox extends javax.swing.JCheckBox {
	...
	public JBindedCheckBox() { super(); }

	/**
	 * @param a
	 */
	public JBindedCheckBox(Action a) { super(a); }

	/**
	 * @param icon
	 * @param selected
	 */
	public JBindedCheckBox(Icon icon, boolean selected) { super(icon, selected); }

	/**
	 * @param icon
	 */
	public JBindedCheckBox(Icon icon) { super(icon); }

	/**
	 * @param text
	 * @param selected
	 */
	public JBindedCheckBox(String text, boolean selected) { super(text, selected); }
	 ...
	 * @param selected
	 */
	public JBindedCheckBox(String text, Icon icon, boolean selected) { super(text, icon, selected); }

	/**
	 * @param text
	 * @param icon
	 */
	public JBindedCheckBox(String text, Icon icon) { super(text, icon); }

	/**
	 * @param text
	 */
	public JBindedCheckBox(String text) { super(text); }
	 ...
	 */
	public Boolean getProperty() { return property.getProperty(); }

	/**
	 * @param value
	 * @see net.ericaro.surfaceplotter.beans.BeanProperty#setProperty(java.lang.Object)
	 */
	public void setProperty(Boolean value) { property.setProperty(value); }

	/**
	 * @return
	 * @see net.ericaro.surfaceplotter.beans.BeanProperty#getPropertyName()
	 */
	public String getPropertyName() { return property.getPropertyName(); }

	/**
	 * @param propertyName
	 * @see net.ericaro.surfaceplotter.beans.BeanProperty#setPropertyName(java.lang.String)
	 */
	public void setPropertyName(String propertyName) { property.setPropertyName(propertyName); }

	/**
	 * @return
	 * @see net.ericaro.surfaceplotter.beans.ModelBindedBeanProperty#getSourceBean()
	 */
	public ModelSource getSourceBean() { return property.getSourceBean(); }

	/**
	 * @param modelSource
	 * @see net.ericaro.surfaceplotter.beans.ModelBindedBeanProperty#setSourceBean(java.lang.Object)
	 */
	public void setSourceBean(ModelSource modelSource) { property.setSourceBean(modelSource); }
