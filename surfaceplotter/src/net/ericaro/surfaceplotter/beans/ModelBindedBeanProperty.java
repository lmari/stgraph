...
public abstract class ModelBindedBeanProperty<PROP> extends BeanProperty<AbstractSurfaceModel, PROP>{
	...
	public ModelBindedBeanProperty(String sourcePropertyName) { setSourcePropertyName(sourcePropertyName); }

	/**
	 * @return the modelSource
	 */
	public ModelSource getSourceBean() { return sourceBeanProperty.getBean(); }

	/**
	 * @param modelSource the modelSource to set
	 */
	public void setSourceBean(ModelSource modelSource) { sourceBeanProperty.setBean(modelSource); }

	/**
	 * @return the modelSourcePropertyName
	 */
	public String getSourcePropertyName() { return sourceBeanProperty.getPropertyName(); }

	/**
	 * @param modelSourcePropertyName the modelSourcePropertyName to set
	 */
	public void setSourcePropertyName(String modelSourcePropertyName) { sourceBeanProperty.setPropertyName(modelSourcePropertyName); }
